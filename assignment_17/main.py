...
class TicTacToe(QMainWindow):
    ...
    def check(self): 
        if ((self.game[0][0].text() == "X" and self.game[1][1].text() == "X" and self.game[2][2].text() == "X") or \
            (self.game[0][2].text() == "X" and self.game[1][1].text() == "X" and self.game[2][0].text() == "X") or \
            (self.game[0][0].text() == "X" and self.game[0][1].text() == "X" and self.game[0][2].text() == "X") or \
            ...
            (self.game[0][2].text() == "X" and self.game[1][2].text() == "X" and self.game[2][2].text() == "X")):
            self.player_score += 1
            ms_box = QMessageBox()
            ...
            ms_box.exec()
            self.new_game()
        elif ((self.game[0][0].text() == "O" and self.game[1][1].text() == "O" and self.game[2][2].text() == "O") or \
            (self.game[0][2].text() == "O" and self.game[1][1].text() == "O" and self.game[2][0].text() == "O") or \
            (self.game[0][0].text() == "O" and self.game[0][1].text() == "O" and self.game[0][2].text() == "O") or \
            ...
            (self.game[0][2].text() == "O" and self.game[1][2].text() == "O" and self.game[2][2].text() == "O")):
